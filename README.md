...
http_archive(
    name = "com_github_devillove084_rules_folly",
    sha256 = "16441df2d454a6d7ef4da38d4e5fada9913d1f9a3b2015b9fe792081082d2a65",
    strip_prefix = "rules_folly-0.2.0",
    urls = [
        "https://github.com/devillove084/rules_folly/archive/v0.2.0.tar.gz",
    ],
)

load("@com_github_devillove084_rules_folly//bazel:folly_deps.bzl", "folly_deps")
folly_deps()
