...
""".format(with_gflags),
    ...
    if with_syslibs:
        maybe(
            ...
            path = "/usr/include",
            build_file = "@com_github_devillove084_rules_folly//third_party/syslibs:double-conversion.BUILD",
        )
    else:
        maybe(
            http_archive,
    ...
    if with_syslibs:
        maybe(
            ...
            name = "zlib",
            path = "/usr/include",
            build_file = "@com_github_devillove084_rules_folly//third_party/syslibs:zlib.BUILD",
        )
    else:
        maybe(
            http_archive,
            ...
            build_file = "@com_github_devillove084_rules_folly//third_party/zlib:zlib.BUILD",
    ...
    if with_syslibs:
        maybe(
            ...
            path = "/usr/include",
            build_file = "@com_github_devillove084_rules_folly//third_party/syslibs:snappy.BUILD",
        )
    else:
        maybe(
            http_archive,
            name = "com_github_google_snappy",
            build_file = "@com_github_devillove084_rules_folly//third_party/snappy:snappy.BUILD",
    ...
    if with_syslibs:
        maybe(
            ...
            path = "/usr/include",
            build_file = "@com_github_devillove084_rules_folly//third_party/syslibs:libevent.BUILD",
        )
    else:
        maybe(
            http_archive,
            ...
            build_file = "@com_github_devillove084_rules_folly//third_party/libevent:libevent.BUILD",
        )
    ...
    maybe(
        ...
        build_file = "@com_github_devillove084_rules_folly//third_party/fmtlib:fmtlib.BUILD",
    )
    ...
    maybe(
        ...
        name = "openssl",
        path = "/usr/include",
        build_file = "@com_github_devillove084_rules_folly//third_party/syslibs:openssl.BUILD",
    )
    ...
    # NOTE(devillove084): The following failed with error:
    ...
    # )
    # TODO(devillove084): Ref: https://github.com/google/glog/blob/master/bazel/glog.bzl
    folly_version = "2021.09.06.00"
    http_archive(
        name = "folly",
        # build_file = "@com_github_devillove084_rules_folly//third_party/folly:folly.BUILD",
        build_file_content = """
load("@com_github_devillove084_rules_folly//bazel:folly.bzl", "folly_library")
...
""".format(with_gflags),
        ...
        patch_args = ["-p1"],
        patches = [
            "@com_github_devillove084_rules_folly//third_party/folly:p00_double_conversion_include_fix.patch",
        ],
    )
